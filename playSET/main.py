...
while True:
    ...
    for c in cnts:
        ...
        if len(approx)==4:
            cv2.putText(img,"Rectangle: ",(x+w+20, y+h+20),cv2.FONT_HERSHEY_COMPLEX,0.7,(0,255,255),2)
        elif len(approx)==3:
            cv2.putText(img,"Triangle: ",(x+w+20, y+h+20),cv2.FONT_HERSHEY_COMPLEX,0.7,(255,255,0),2)
        else:
            cv2.putText(img,"Circle: ",(x+w+20, y+h+20),cv2.FONT_HERSHEY_COMPLEX,0.7,(255,255,255),2)
